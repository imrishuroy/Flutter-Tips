// https://raw.githubusercontent.com/vandadnp/flutter-tips-and-tricks/main/images/expansion-panels-and-lists-in-flutter.jpg
...
class _ExpansionListState extends State<ExpansionList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Expansion Panels in Flutter'),
      ),
